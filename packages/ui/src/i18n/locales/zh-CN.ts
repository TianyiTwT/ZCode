...
const zhCN: Record<string, string> = {
  ...
  "sidebar.profile.localFallback": "本地用户",
  ...
  "settings.appearance.profileTitle": "个人资料",
  "settings.appearance.profileDescription":
    "侧边栏底部的头像和名称，无需登录，离线保存。",
  "settings.localProfile.showInSidebar": "在侧边栏显示头像和名称",
  "settings.localProfile.showInSidebarDescription": "关闭后侧边栏底部只保留设置入口。",
  "settings.localProfile.name": "名称",
  "settings.localProfile.nameDescription": "最多 24 个字符，留空时显示默认名称。",
  "settings.localProfile.namePlaceholder": "输入显示名称",
  "settings.localProfile.avatar": "头像",
  "settings.localProfile.avatarDescription":
    "支持 PNG、JPG、WebP 等图片格式。",
  "settings.localProfile.avatarChoose": "选择图片",
  "settings.localProfile.avatarRemove": "移除",
  "settings.localProfile.avatarError": "这张图片无法用作头像，请换一张。",
  "settings.localProfile.avatarUnsupportedType": "请选择图片文件（PNG、JPG、WebP 等）。",
  "settings.localProfile.avatarTooLarge": "图片压缩后仍然过大，请换一张尺寸更小的图片。",
  "settings.localProfile.cropTitle": "调整头像",
  "settings.localProfile.cropDescription":
    "拖动图片调整位置，用滑块或滚轮缩放。圆形以外的部分会被裁掉。",
  "settings.localProfile.cropZoom": "缩放",
  "settings.localProfile.cropCanvasLabel":
    "头像取景框。拖动可调整位置，方向键微调，按住 Shift 方向键加速。",
  "settings.localProfile.cropCancel": "取消",
  "settings.localProfile.cropConfirm": "保存",
  ...
  "settings.modelProvider.catalog.fetch": "获取可用模型",
  "settings.modelProvider.catalog.title": "可用模型",
  "settings.modelProvider.catalog.description":
    "从该供应商的模型列表接口读取。拉取到的模型与手动添加的模型完全等价，都是同一份配置。",
  "settings.modelProvider.catalog.descriptionWithProvider":
    "从 {provider} 的模型列表接口读取。拉取到的模型与手动添加的模型完全等价。",
  "settings.modelProvider.catalog.filter": "筛选模型",
  "settings.modelProvider.catalog.loading": "正在获取模型列表",
  "settings.modelProvider.catalog.empty": "没有匹配的模型。",
  "settings.modelProvider.catalog.added": "已添加",
  "settings.modelProvider.catalog.notAdded": "未添加",
  "settings.modelProvider.catalog.action.add": "添加模型 {model}",
  "settings.modelProvider.catalog.action.remove": "移除模型 {model}",
  "settings.modelProvider.catalog.count": "{count} 个模型",
  "settings.modelProvider.catalog.refresh": "重新获取",
  "settings.modelProvider.catalog.close": "关闭",
  "settings.modelProvider.catalog.failed.unsupported":
    "该供应商没有提供模型列表接口，请用「添加模型」手动填写模型 ID。",
  "settings.modelProvider.catalog.failed.unauthorized": "API Key 无效或没有权限，请检查后重试。",
  "settings.modelProvider.catalog.failed.network": "请求失败，请检查网络或 Base URL 后重试。",
  "settings.modelProvider.catalog.failed.invalid-response":
    "接口返回了无法识别的数据，请手动填写模型 ID。",
  "settings.modelProvider.catalog.failed.not-configured":
    "该供应商尚未填写并保存 Base URL 或 API Key。",
